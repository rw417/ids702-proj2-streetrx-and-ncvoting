...
\begin{center}\includegraphics[width=0.75\linewidth]{lorazepam_price_files/figure-latex/interactions-1} \end{center}
...
\begin{center}\includegraphics[width=0.75\linewidth]{lorazepam_price_files/figure-latex/assess_2-1} \end{center}
